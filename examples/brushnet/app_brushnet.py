...
mobile_sam = sam_model_registry['vit_h'](checkpoint='models/sam/sam_vit_h_4b8939.pth').to("cuda")
mobile_sam.eval()
...
base_model_path = "models/base_model/realisticVisionV60B1_v51VAE"
# base_model_path = "runwayml/stable-diffusion-v1-5"

# input brushnet ckpt path
brushnet_path = "models/brushnetX"
        ...
        with gr.Column():
            ...
            gr.HTML(f"""
                    <div style="text-align: center;">
                        <h1>BrushNetX: A Plug-and-Play Image Inpainting Model with Decomposed Dual-Branch Diffusion</h1>
